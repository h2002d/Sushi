...
namespace LaserArt.Models
{
    public class Product
    {
        ...
        [Required]
        public string ProductTitle_AM { get; set; }
        [Required]
        public string ProductTitle_EN { get; set; }
        [Required]
        public string ProductTitle_RU { get; set; }
        public string ProductDescription { get; set; }

        [Required]
        public string ProductDescription_AM { get; set; }
        [Required]
        public string ProductDescription_EN { get; set; }
        [Required]
        public string ProductDescription_RU { get; set; }
        [Required]
